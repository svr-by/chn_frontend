...
import { getGetCompaniesCompanyIdRequestsInboundRequestIdLinesCsvUrl } from '@/api/generated/endpoints';
import {
  ImportFormatOptions,
...
interface QuoteLinesCsvExportDialogProps {
  open: boolean;
  onClose: () => void;
  companyId: string;
  requestId: string;
...
export function QuoteLinesCsvExportDialog({
  open,
  onClose,
  companyId,
  requestId,
}: QuoteLinesCsvExportDialogProps) {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      const path = getGetCompaniesCompanyIdRequestsInboundRequestIdLinesCsvUrl(
        companyId,
        requestId,
        {
