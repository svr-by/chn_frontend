...
void i18n.use(initReactI18next).init({
  ...
  defaultNS: 'common',
  ns: ['common', 'auth', 'nav', 'errors', 'team', 'profile', 'partners', 'products', 'requests', 'imports', 'quotes', 'selections', 'invoices', 'payments', 'shipping', 'consolidations', 'collaboration', 'notifications', 'enums'],
});
