...
import type { QuoteOfferInputRejectedAt } from './quoteOfferInputRejectedAt';
import type { QuoteOfferInputRejectionReason } from './quoteOfferInputRejectionReason';
...
export interface QuoteOfferInput {
  ...
  rejectedAt: QuoteOfferInputRejectedAt;
  rejectionReason: QuoteOfferInputRejectionReason;
  currency: string;
