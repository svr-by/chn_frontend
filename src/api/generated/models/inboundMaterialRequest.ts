 ...
 */
import type { InboundMaterialRequestCreatedBy } from './inboundMaterialRequestCreatedBy';
import type { InboundMaterialRequestAssignee } from './inboundMaterialRequestAssignee';
...
export interface InboundMaterialRequest {
  ...
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  companyId: string;
  createdBy: InboundMaterialRequestCreatedBy;
  assignee: InboundMaterialRequestAssignee;
  title: string;
